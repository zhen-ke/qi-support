...
We respect your privacy and are committed to protecting it. This Privacy Policy explains our policies regarding the collection, use, and disclosure of information when you use our App.
...
* The App does not integrate any third-party analytics, tracking tools, or advertising networks that collect or track user data.
* We do not sell, trade, or rent any user information to third parties.

### 3. Permissions

The App only requests standard device permissions necessary for its core functionalities to operate properly on your device. These permissions are not used to harvest or track personal information.

### 4. Children's Privacy

Because our App does not collect any personal data, it is compliant with the Children's Online Privacy Protection Act (COPPA) and is safe for users of all ages, including children under the age of 13.
